...
// GradientWaves WebGL 背景(从 gradient-waves.js 移植为 React 组件)
...
const THEMES: Record<string, { horizon: string; wave: string; crest: string }> = {
...
export default function GradientWaves() {
  ...
  return (
    <canvas
      ref={canvasRef}
      id="gradient-waves"
      className="pointer-events-none fixed bottom-0 left-0 right-0 z-[-1]"
